...
module strings_module
  ...
  !>
  !!## NAME
  !!    glob(3f) - [strings_module:COMPARE] compare given string for match to
  ...
  ! @(#)strings_module::glob(3f): function compares text strings, one of which can have wildcards ('*' or '?').
  ...
  !>
  !!### NAME
  !!   notabs(3f) - [strings_module:NONALPHA] expand tab characters
  !!   (LICENSE:PD)
  !!
  !!### SYNOPSIS
  !!
  ...
  !!    use strings_module, only : notabs
  ...
  ! ident_31="@(#)strings_module::notabs(3f): convert tabs to spaces while maintaining columns, remove CRLF chars"
